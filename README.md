...
`GROQ_API_KEY` and, once you have a frontend URL, `CORS_ORIGINS`.
...
reporting whether `GROQ_API_KEY` is set, whether the parse cache directory
...
3. Set the `GROQ_API_KEY` variable in the service's Variables tab.
